package edu.ncit.datagen.tables;
...
public class UserVisits {
    ...
    public UserVisits(Path[] cacheFiles, String delim, long numUrls) throws IOException {
        rand = new Random();
        date = new Date();
        ...
        if ((null != cacheFiles) && (cacheFiles.length > 0)) {
            for (Path cachePath : cacheFiles) {
                ...
                if (cachePath.getName().contains(StructuredData.uagentf)) {
                ...
                } else if (cachePath.getName().contains(StructuredData.countryf)) {
                ...
                } else if (cachePath.getName().contains(StructuredData.searchkeyf)) {
